...
> - Users might not see their previous conversations when they reconnect
...
- Refresh the session token and pass it to the SDK through `successCompletion(newToken)`.
