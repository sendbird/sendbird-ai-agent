...
> For details on setting context at initialization, refer to the [Android messenger quickstart guide](quickstart-guide-messenger.md#passing-context-object-to-ai-agent).
