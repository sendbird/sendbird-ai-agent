...
> For details on setting context at initialization, refer to the [JavaScript messenger quickstart guide](quickstart-guide-messenger.md#passing-context-object-to-ai-agent).
