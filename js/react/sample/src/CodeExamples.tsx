...
export function CodeExamples({ activeExample, onExampleChange, copyFeedback, onCopy }: CodeExamplesProps) {
      ...
      <div className="bg-gray-900 rounded-lg shadow overflow-hidden">
        <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-300 font-medium">{getExampleTitle(activeExample)}</span>
